...
Page({
  ...
  //1-5标签选择
  choose1:function(ev){
    this.changeLabelColor(0,ev);
  
  },
  choose2: function (ev) {
    this.changeLabelColor(1,ev);
  },
  choose3: function (ev) {
    this.changeLabelColor(2,ev);
  },
  choose4: function (ev) {
    this.changeLabelColor(3,ev);
  },
  choose5: function (ev) {
    this.changeLabelColor(4,ev);
  },
  //限制信息提示
  ...
  getPicture:function(){
    ...
    wx.chooseImage({
      ...
      success: function(res) {
        ...
        //成功提示
        var str = that.data.chooseImgInfo[0];
        that.errorAlert(str);
        console.log(res);
      },
      //失败回调
      fail:function(){
        //失败提示
        var str = that.data.chooseImgInfo[1];
        that.errorAlert(str);
      }
    })
},
